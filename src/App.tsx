...
const guideArticles: GuideArticle[] = [
...

  {
    ...
    category: "Avion",
    iconKey: "plane",
    title: "Surbooking : que faire en cas de refus d’embarquement ?",
    excerpt: "Vos réflexes si la compagnie refuse l’embarquement alors que vous aviez une réservation confirmée.",
    readTime: "4 min",
    intro: "Le surbooking arrive lorsqu’une compagnie vend plus de billets que de places disponibles. Si vous êtes refusé à l’embarquement contre votre volonté, certains droits peuvent s’appliquer.",
    sections: [
      { title: "Quels sont vos premiers réflexes ?", body: ["Demandez une confirmation écrite du refus d’embarquement et conservez votre carte d’embarquement ou votre réservation. Notez l’heure, le vol concerné et les propositions faites par la compagnie.", "Évitez de quitter l’aéroport sans document : une preuve écrite facilite beaucoup la réclamation." ] },
      { title: "Que peut-on demander ?", body: ["Selon les circonstances, vous pouvez demander une prise en charge, un réacheminement ou un remboursement, ainsi qu’une indemnisation forfaitaire si les conditions sont réunies.", "Le montant dépend notamment de la distance du vol et de la situation exacte." ] },
      { title: "Comment rédiger la réclamation ?", body: ["La lettre doit rappeler la réservation, le numéro de vol, la date, le refus d’embarquement et les conséquences directes. Restez factuel et demandez une réponse écrite." ] },
    ],
    checklist: ["Réservation", "Carte d’embarquement", "Attestation de refus si disponible", "Échanges avec la compagnie", "Justificatifs de frais"],
  },
  {
    slug: "vol-annule-moins-14-jours",
    claimId: "vol",
    category: "Avion",
    iconKey: "plane",
    title: "Vol annulé moins de 14 jours avant le départ : vos droits",
    excerpt: "Les conditions à vérifier avant de demander une indemnisation ou un remboursement.",
    readTime: "5 min",
    intro: "Une annulation de vol peu de temps avant le départ peut ouvrir droit à une prise en charge, un remboursement ou une indemnisation selon la situation.",
    sections: [
      { title: "Le délai d’information compte", body: ["Le moment où la compagnie vous informe de l’annulation est important. Une annulation annoncée tardivement peut renforcer votre demande, sauf circonstances particulières.", "Conservez l’email ou le SMS d’annulation avec la date et l’heure de réception." ] },
      { title: "Remboursement et indemnisation : deux sujets différents", body: ["Le remboursement du billet et l’indemnisation forfaitaire ne répondent pas toujours aux mêmes règles. Vous pouvez avoir droit à l’un, à l’autre, ou aux deux selon les faits." ] },
      { title: "Que mettre dans la lettre ?", body: ["Indiquez la référence du vol, la date, le trajet, la date d’annonce de l’annulation et ce que vous demandez précisément. Joignez les preuves utiles." ] },
    ],
    checklist: ["Email/SMS d’annulation", "Réservation", "Numéro de vol", "Preuve de paiement", "Frais éventuels documentés"],
  },
  {
    slug: "horodateur-en-panne-contestation",
    claimId: "parking",
    category: "Stationnement",
    iconKey: "parking",
    title: "Horodateur en panne : peut-on contester une amende ?",
    excerpt: "Les preuves utiles et la manière de présenter une contestation crédible.",
    readTime: "4 min",
    intro: "Un horodateur en panne peut être un argument de contestation, mais il faut le documenter précisément.",
    sections: [
      { title: "Quelles preuves réunir ?", body: ["Prenez une photo de l’horodateur, du message d’erreur, de la rue et de la signalisation. Si possible, montrez que les autres moyens de paiement n’étaient pas accessibles." ] },
      { title: "Que faut-il éviter ?", body: ["Évitez les contestations vagues du type “la machine ne marchait pas” sans preuve. Plus votre dossier est factuel, plus il est crédible." ] },
      { title: "Comment formuler la demande ?", body: ["Expliquez calmement les circonstances, joignez les photos et demandez l’annulation ou le réexamen de l’avis." ] },
    ],
    checklist: ["Photo de l’horodateur", "Photo de la signalisation", "Avis reçu", "Capture d’application si paiement impossible", "Témoignage éventuel"],
  },
  {
    slug: "retenues-abusives-caution",
    claimId: "caution",
    category: "Logement",
    iconKey: "home",
    title: "Retenues abusives sur caution : comment demander les justificatifs ?",
    excerpt: "Comprendre ce que le propriétaire peut retenir et comment exiger un décompte clair.",
    readTime: "5 min",
    intro: "Un propriétaire peut retenir une partie du dépôt de garantie, mais ces retenues doivent être justifiées. Une demande écrite permet d’obtenir un décompte clair.",
    sections: [
      { title: "Une retenue doit être expliquée", body: ["Une somme retenue doit correspondre à un élément précis : réparation locative, loyer impayé, charges ou dégradation constatée. Demandez les justificatifs correspondants." ] },
      { title: "Comparer les états des lieux", body: ["La comparaison entre l’état des lieux d’entrée et de sortie est essentielle. Une dégradation déjà présente à l’entrée ne devrait pas vous être imputée." ] },
      { title: "Quand envoyer une mise en demeure ?", body: ["Si le bailleur ne répond pas ou refuse de fournir des justificatifs, une mise en demeure permet de formaliser votre demande avant une éventuelle conciliation." ] },
    ],
    checklist: ["État des lieux d’entrée", "État des lieux de sortie", "Factures/devis transmis", "Bail", "Échanges avec le bailleur"],
  },
  {
    slug: "colis-endommage-preuves",
    claimId: "colis",
    category: "Livraison",
    iconKey: "package",
    title: "Colis endommagé : les preuves à conserver dès la réception",
    excerpt: "Photos, emballage, réserves : les bons réflexes pour éviter un refus de prise en charge.",
    readTime: "4 min",
    intro: "Quand un colis arrive abîmé, les premières minutes sont importantes. Plus vous documentez vite, plus votre réclamation est solide.",
    sections: [
      { title: "Photographier avant de jeter", body: ["Prenez des photos de l’emballage extérieur, de l’étiquette, de l’intérieur du colis et du produit abîmé. Gardez l’emballage jusqu’à la fin du dossier." ] },
      { title: "Signaler rapidement", body: ["Prévenez le vendeur ou le transporteur dès que possible. Si vous avez émis des réserves à la livraison, mentionnez-les dans votre demande." ] },
      { title: "Que demander ?", body: ["Selon le cas, demandez un remboursement, un remplacement ou une indemnisation. Indiquez la valeur du produit et joignez la preuve d’achat." ] },
    ],
    checklist: ["Photos du colis", "Photos du produit", "Étiquette de transport", "Preuve d’achat", "Message envoyé au vendeur/transporteur"],
  },
  {
    slug: "retard-train-justificatifs",
    claimId: "train",
    category: "Train",
    iconKey: "train",
    title: "Retard de train : quels justificatifs fournir ?",
    excerpt: "Les documents qui rendent votre demande de compensation plus claire et plus facile à traiter.",
    readTime: "3 min",
    intro: "Une demande de compensation ferroviaire est plus efficace lorsqu’elle contient les informations exactes du trajet et les bons justificatifs.",
    sections: [
      { title: "Les informations indispensables", body: ["Indiquez le numéro du train, la date du trajet, les gares de départ et d’arrivée, la durée du retard et le prix du billet." ] },
      { title: "Les documents utiles", body: ["Conservez votre e-billet, la confirmation d’achat, une capture d’écran de l’application ou tout message officiel indiquant le retard." ] },
      { title: "Présenter une demande claire", body: ["Votre courrier doit être court, précis et chiffré. Évitez les longs récits : les services réclamations traitent plus facilement une demande structurée." ] },
    ],
    checklist: ["E-billet", "Confirmation d’achat", "Capture du retard", "Prix du billet", "Référence de dossier si disponible"],
  },
];
